...
const Player = () => {
  return (
    <div className='h-[30%] bg-black flex justify-between items-center text-white px-1'>
      <div className="hidden lg:flex items-center gap-4">
       ...
       <div className='flex flex-col items-center justify-between gap-1 m-auto'>
        ...
        <div className='flex items-center gap-5'>
            <p>1:06</p>
            <div className='w-[60vw] max-w-[500px] bg-gray-300 rounded-full items-center justify-between cursor-pointer'>
